...
var init_layout_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_layout.svelte.js"() {
    ...
    Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<div class="${"w-screen"}"><div class="${"container mx-auto p-8"}">${slots.default ? slots.default({}) : ``}</div></div>`;
    });
  }
});
...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    ...
    file = "_app/immutable/entry/_layout.svelte.991d82a4.js";
    imports = ["_app/immutable/entry/_layout.svelte.991d82a4.js", "_app/immutable/chunks/index.ba240e3a.js"];
    stylesheets = ["_app/immutable/assets/_layout.36fec612.css"];
    fonts = [];
  }
});
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    ...
    file2 = "_app/immutable/entry/error.svelte.1b01fe91.js";
    imports2 = ["_app/immutable/entry/error.svelte.1b01fe91.js", "_app/immutable/chunks/index.ba240e3a.js", "_app/immutable/chunks/singletons.8cd8906d.js"];
    stylesheets2 = [];
    fonts2 = [];
  }
});
...
var init_page_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_page.svelte.js"() {
    ...
    Link = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      if ($$props.href === void 0 && $$bindings.href && href !== void 0)
        $$bindings.href(href);
      return `<a${add_attribute("href", href, 0)} target="${"_blank"}" rel="${"noreferrer"}" class="${"inline-flex items-center gap-x-1 bg-blue-500/10 px-1 text-blue-500 transition-colors hover:bg-blue-500/25 hover:text-blue-800"}"><div>${slots.default ? slots.default({}) : ``}</div>

  <svg xmlns="${"http://www.w3.org/2000/svg"}" class="${"aspect-square h-4 w-4 "}" viewBox="${"0 0 24 24"}"><path fill="${"currentColor"}" d="${"M5 17.59 15.59 7H9V5h10v10h-2V8.41L6.41 19 5 17.59Z"}"></path></svg></a>`;
    });
    Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<div class="${"font-mono selection:bg-blue-500/50 "}"><div class="${"grid grid-cols-2 border-2 border-blue-500 py-2 px-4"}"><div class="${"flex items-center"}"><div class="${"flex items-center gap-x-2"}"><span class="${"relative flex h-3 w-3"}"><span class="${"absolute inline-flex h-full w-full animate-ping rounded-full bg-blue-500/75"}"></span>
          <span class="${"relative inline-flex h-3 w-3 rounded-full bg-blue-500"}"></span></span>
        <h1 class="${"text-xl"}">josh king</h1></div></div>
    <div><p class="${"text-xl tabular-nums"}">${escape(time)}</p></div></div>
  <div class="${"border-x-2 border-blue-500 py-2 px-4 sm:grid sm:grid-cols-2"}"><div class="${"mb-4"}"><p class="${"mb-1 uppercase text-grey"}">Who.</p>
      <h1 class="${"text-blue-500"}">Product interface engineer.</h1>
      <p>Based in London, United Kingdom. Focusing on serverless technologies
      </p></div>

    <div class="${"mb-4"}"><p class="${"mb-1 uppercase text-grey"}">Where.</p>
      ${each(work, ({ company, role, timeline, website }) => {
        return `${validate_component(Link, "Link").$$render($$result, { href: website }, {}, {
          default: () => {
            return `${escape(company)}
        `;
          }
        })}
        <p>${escape(role)}</p>
    ...
    <div class="${"hidden items-center px-6 sm:flex"}"><div><p class="${"mb-1 italic"}">&quot;Everything we see is <br> perspective, not truth.&quot;
        </p>
        <p class="${"text-blue-500"}">- Marcus Aurelius</p></div></div>

    <div><p class="${"mb-1 uppercase text-grey"}">What.</p>
      <div class="${"space-y-1"}">${each(clients, ({ name, work: work2 }) => {
        return `<div><h1 class="${"text-blue-500"}">${escape(name)}</h1>
            <p>${escape(work2)}</p>
          </div>`;
      })}</div></div></div>

  <div class="${"col-span-2 border-2 border-blue-500 py-2 px-4"}"><p class="${"mb-1 uppercase text-grey"}">Contact.</p>
    <div class="${"flex gap-x-4"}">${each(contact, ({ name, url }) => {
        return `${validate_component(Link, "Link").$$render($$result, { href: url }, {}, {
          default: () => {
            return `${escape(name)}
        `;
          }
  ...
  <div class="${"my-2"}"><p class="${"text-sm text-grey"}">Built with Svelte &amp; Vite. Font BerkeleyMono.
    </p></div></div>`;
    });
  }
});
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    ...
    file3 = "_app/immutable/entry/_page.svelte.8fffc75c.js";
    imports3 = ["_app/immutable/entry/_page.svelte.8fffc75c.js", "_app/immutable/chunks/index.ba240e3a.js"];
    stylesheets3 = [];
    fonts3 = [];
  }
});
...
var options = {
  ...
  templates: {
    app: ({ head, body, assets: assets2, nonce, env }) => '<!DOCTYPE html>\n<html lang="en">\n  <head>\n    <meta charset="utf-8" />\n    <title>Josh King</title>\n    <meta\n      name="description"\n      content="Product interface engineer. Based in London, United Kingdom."\n    />\n    <meta name="viewport" content="width=device-width" />\n    <!-- Facebook Meta Tags -->\n    <meta property="og:url" content="https://joshking.dev" />\n    <meta property="og:type" content="website" />\n    <meta property="og:title" content="Josh King" />\n    <meta\n      property="og:description"\n      content="Product interface engineer. Based in London, United Kingdom."\n    />\n    <meta property="og:image" content="https://joshking.dev/favicon.svg" />\n\n    <!-- Twitter Meta Tags -->\n    <meta name="twitter:card" content="summary_large_image" />\n    <meta property="twitter:domain" content="joshking.dev" />\n    <meta property="twitter:url" content="https://joshking.dev" />\n    <meta name="twitter:title" content="Josh King" />\n    <meta\n      name="twitter:description"\n      content="Product interface engineer. Based in London, United Kingdom."\n    />\n    <meta name="twitter:image" content="https://joshking.dev/favicon.svg" />\n    ' + head + "\n  </head>\n  <body>\n    <div>" + body + "</div>\n  </body>\n</html>\n",
...
var manifest = {
  appDir: "_app",
  appPath: "_app",
  assets: /* @__PURE__ */ new Set(["android-chrome-192x192.png", "android-chrome-512x512.png", "apple-touch-icon.png", "favicon-16x16.png", "favicon-32x32.png", "favicon.ico", "favicon.svg", "fonts/BerkeleyMono-Regular.woff2", "site.webmanifest"]),
  mimeTypes: { ".png": "image/png", ".ico": "image/vnd.microsoft.icon", ".svg": "image/svg+xml", ".woff2": "font/woff2", ".webmanifest": "application/manifest+json" },
  _: {
    client: { "start": { "file": "_app/immutable/entry/start.abe43e4b.js", "imports": ["_app/immutable/entry/start.abe43e4b.js", "_app/immutable/chunks/index.ba240e3a.js", "_app/immutable/chunks/singletons.8cd8906d.js"], "stylesheets": [], "fonts": [] }, "app": { "file": "_app/immutable/entry/app.17dd4ba0.js", "imports": ["_app/immutable/entry/app.17dd4ba0.js", "_app/immutable/chunks/index.ba240e3a.js"], "stylesheets": [], "fonts": [] } },
    nodes: [
